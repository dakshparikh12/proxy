...
WORKROOM_PRIME = (
    ...
    "research the web when useful, draft real files. Cite real file:line and real results — never "
    ...
    "Handle whatever comes at you like a great teammate: if you are genuinely blocked, ask ONE concise "
