...
# ``services/in-meeting/src/transport/chat.py`` gates DM delivery on ``report.dm_available`` (chat.py:224)
# and ``services/in-meeting/src/transport/surface.py`` conformance-checks it (surface.py:73/85, via an
