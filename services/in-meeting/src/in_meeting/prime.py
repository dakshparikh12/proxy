...
WORKROOM_PRIME = (
    ...
    "non-spoken channels: chat, dm (needs `to`), screen (show a URL OR raw HTML/text content — "
    "prefer content YOU produce, since external sites often refuse to embed), offer (stage a "
