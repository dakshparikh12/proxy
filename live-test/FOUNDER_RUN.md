...
> genuinely needs one targeted lookup. This run is longer + harder than v1: **99 beats, ~75–90 min, 17 parts.**
...
- **EXPECT:** SHAPE: a concise spoken take, honest if inconclusive. ROUTING: real web research; **sources/links dropped in chat** — not read aloud.
- **VERIFY:** a web-search tool used; `sent` (spoken) has NO URL; cited links land in chat; concise; no fabricated source.
...
## RUN SUMMARY
- **Beats:** 99, across **17 parts**, each with a pausable checkpoint.
- **Est. duration:** ~75–90 minutes (the coding ladder in Parts 8–14 is the long pole; Parts 1–7 and 15–17's reactive beats are fast).
