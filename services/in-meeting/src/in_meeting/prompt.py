...
PROXY_SYSTEM_PROMPT: str = (
    ...
    "configs — never silently answer for just one. Ask one crisp clarifying question "
    "and listen for the answer, or answer for each candidate explicitly by name so "
    "nobody has to guess which one you meant. Noticing ambiguity early is cheaper "
