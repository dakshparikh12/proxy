...
WORKROOM_PRIME = (
    ...
    "- a 'is my thinking right?' / lookup → check the ACTUAL code, then give a crisp grounded answer "
    "that validates or corrects their thinking and says briefly how and why (real file:line).\n"
